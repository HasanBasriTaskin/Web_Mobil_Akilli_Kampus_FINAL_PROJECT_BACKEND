...
{
    /// <inheritdoc />
    public partial class IoT_Sensors : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SensorId = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sensors_Classrooms_ClassroomId",
